                    ...
                    <button
                        ...
                        className={`px-4 py-2 rounded-full text-sm font-semibold whitespace-nowrap transition ${
                            selectedCategory === cat
                                ...
                                : 'bg-gray-100 dark:bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-100 dark:bg-gray-700'
                        }`}
                    >
                        ...
                        <div className="p-4">
                            ...
                            <div className="flex gap-2 mt-4">
                                ...
                                <button
                                    ...
                                    className="flex-1 py-2 bg-gray-100 dark:bg-gray-100 dark:bg-gray-700 hover:bg-red-100 dark:hover:bg-red-900/30 text-red-600 dark:text-red-400 rounded-lg text-sm font-semibold transition flex items-center justify-center gap-1"
                                >
                                    <Trash2 size={14} />
                                    {t('delete')}
                                </button>
