  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center flex-wrap gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-900 dark:text-gray-900 dark:text-white">{t('staffManagement')}</h1>
          <p className="text-gray-500 dark:text-gray-500 dark:text-gray-500 dark:text-gray-400 mt-1">{t('manageStaffAccountsAndPermissions')}</p>
        </div>
        <div className="flex gap-3">
          <button
            onClick={handleRefresh}
            disabled={refreshing}
            className="bg-gray-100 dark:bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-600 dark:text-gray-600 dark:text-gray-300 px-4 py-2 rounded-xl font-semibold flex items-center gap-2 transition"
          >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <div className="bg-white dark:bg-white dark:bg-white dark:bg-gray-800 rounded-xl p-3 text-center border border-gray-200 dark:border-gray-200 dark:border-gray-200 dark:border-gray-700">
          <p className="text-xs text-gray-500 dark:text-gray-500 dark:text-gray-500 dark:text-gray-400">{t('totalStaff')}</p>
          <p className="text-xl font-bold text-gray-900 dark:text-gray-900 dark:text-gray-900 dark:text-white">{staff.length}</p>
        </div>
        <div className="bg-white dark:bg-white dark:bg-white dark:bg-gray-800 rounded-xl p-3 text-center border border-gray-200 dark:border-gray-200 dark:border-gray-200 dark:border-gray-700">
          <p className="text-xs text-gray-500 dark:text-gray-500 dark:text-gray-500 dark:text-gray-400">{t('active')}</p>
        ...
        <div className="bg-white dark:bg-white dark:bg-white dark:bg-gray-800 rounded-xl p-3 text-center border border-gray-200 dark:border-gray-200 dark:border-gray-200 dark:border-gray-700">
          <p className="text-xs text-gray-500 dark:text-gray-500 dark:text-gray-500 dark:text-gray-400">{t('pending')}</p>
          <p className="text-xl font-bold text-yellow-600 dark:text-yellow-400">{staff.filter(s => s.status === 'pending').length}</p>
        </div>
        <div className="bg-white dark:bg-white dark:bg-white dark:bg-gray-800 rounded-xl p-3 text-center border border-gray-200 dark:border-gray-200 dark:border-gray-200 dark:border-gray-700">
          <p className="text-xs text-gray-500 dark:text-gray-500 dark:text-gray-500 dark:text-gray-400">{t('roles')}</p>
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-gray-50 dark:bg-gray-100 dark:bg-gray-700/50">
              <tr>
                <th className="px-6 py-3 text-left text-gray-600 dark:text-gray-500 dark:text-gray-500 dark:text-gray-400 text-sm font-semibold">{t('name')}</th>
                <th className="px-6 py-3 text-left text-gray-600 dark:text-gray-500 dark:text-gray-500 dark:text-gray-400 text-sm font-semibold">{t('email')}</th>
                <th className="px-6 py-3 text-left text-gray-600 dark:text-gray-500 dark:text-gray-500 dark:text-gray-400 text-sm font-semibold">{t('role')}</th>
                <th className="px-6 py-3 text-left text-gray-600 dark:text-gray-500 dark:text-gray-500 dark:text-gray-400 text-sm font-semibold">{t('phone')}</th>
                <th className="px-6 py-3 text-left text-gray-600 dark:text-gray-500 dark:text-gray-500 dark:text-gray-400 text-sm font-semibold">{t('status')}</th>
                <th className="px-6 py-3 text-left text-gray-600 dark:text-gray-500 dark:text-gray-500 dark:text-gray-400 text-sm font-semibold">{t('joinDate')}</th>
                <th className="px-6 py-3 text-left text-gray-600 dark:text-gray-500 dark:text-gray-500 dark:text-gray-400 text-sm font-semibold">{t('actions')}</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
              {filteredStaff.length === 0 ? (
                <tr>
                  <td colSpan="7" className="px-6 py-12 text-center text-gray-500 dark:text-gray-500 dark:text-gray-500 dark:text-gray-400">
                    <Users size={40} className="mx-auto mb-3 text-gray-500 dark:text-gray-500 dark:text-gray-400 dark:text-gray-600" />
                    {t('noStaffMembersFound')}
                    <p className="text-sm text-gray-500 dark:text-gray-500 dark:text-gray-400 dark:text-gray-500 mt-1">{t('clickAddStaffToCreate')}</p>
                  </td>
                </tr>
              ) : (
                filteredStaff.map(member => (
                  <tr key={member.id} className="hover:bg-gray-50 dark:hover:bg-gray-100 dark:bg-gray-700/50 transition">
                    <td className="px-6 py-4">
                      <span className="text-gray-900 dark:text-gray-900 dark:text-gray-900 dark:text-white font-medium">{member.name}</span>
                    </td>
                    <td className="px-6 py-4 text-gray-600 dark:text-gray-500 dark:text-gray-500 dark:text-gray-400 text-sm">{member.email}</td>
                    <td className="px-6 py-4">
                      <span className={`px-2 py-1 rounded-lg text-xs font-semibold capitalize ${getRoleColor(member.role)}`}>
                        {t(member.role)}
                      </span>
                    </td>
                    <td className="px-6 py-4 text-gray-600 dark:text-gray-500 dark:text-gray-500 dark:text-gray-400 text-sm">{member.phone || '-'}</td>
                    <td className="px-6 py-4">
                      {getStatusBadge(member.status, member.is_active)}
                    </td>
                    <td className="px-6 py-4 text-gray-500 dark:text-gray-500 dark:text-gray-500 dark:text-gray-400 text-xs">
          ...
          <div className="bg-white dark:bg-white dark:bg-white dark:bg-gray-800 rounded-2xl w-full max-w-md border border-gray-200 dark:border-gray-200 dark:border-gray-200 dark:border-gray-700">
            <div className="p-6">
              <div className="flex justify-between items-center mb-4">
                ...
                <button onClick={resetModal} className="text-gray-500 dark:text-gray-500 dark:text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-600 dark:text-gray-600 dark:text-gray-300 transition">
                  <X size={20} />
                </button>
              </div>
                ...
                {!editingStaff && (
                  <div>
                    ...
                    <input
                      ...
                      required
                    />
                    <p className="text-xs text-gray-500 dark:text-gray-500 dark:text-gray-500 dark:text-gray-400 mt-1">{t('passwordMinLengthHint')}</p>
                  </div>
                )}

                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-600 dark:text-gray-600 dark:text-gray-300 mb-1">{t('role')} *</label>
                  <select
                    value={formData.role}
