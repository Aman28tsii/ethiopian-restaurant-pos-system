  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center flex-wrap gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-900 dark:text-white">{t('customerManagement')}</h1>
          <p className="text-gray-500 dark:text-gray-500 dark:text-gray-400 mt-1">{t('manageCustomerAccounts')}</p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-gradient-to-r from-purple-600 to-purple-700 rounded-xl p-4 text-gray-900 dark:text-white">
          <Users size={24} className="mb-2 opacity-80" />
          <p className="text-purple-200 text-sm">{t('totalCustomers')}</p>
          <p className="text-2xl font-bold">{totalCustomers}</p>
        </div>
        <div className="bg-gradient-to-r from-yellow-600 to-yellow-700 rounded-xl p-4 text-gray-900 dark:text-white">
        ...
        <div className="bg-gradient-to-r from-green-600 to-green-700 rounded-xl p-4 text-gray-900 dark:text-white">
          <TrendingUp size={24} className="mb-2 opacity-80" />
          <p className="text-green-200 text-sm">{t('totalSpent')}</p>
          <p className="text-2xl font-bold">{formatCurrency(totalSpent)}</p>
        </div>
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl p-4 text-gray-900 dark:text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {filteredCustomers.map(customer => (
          <div key={customer.id} className="bg-white dark:bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-200 dark:border-gray-700 overflow-hidden hover:border-gray-300 dark:hover:border-gray-300 dark:border-gray-600 transition-all shadow-sm hover:shadow-md">
            <div className="p-5">
              <div className="flex justify-between items-start mb-3">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center text-gray-900 dark:text-white font-bold text-xl">
                    {customer.name?.charAt(0)}
                  </div>
                  <div>
                    <h3 className="font-bold text-gray-900 dark:text-gray-900 dark:text-white text-lg">{customer.name}</h3>
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-center gap-2 text-gray-500 dark:text-gray-500 dark:text-gray-400">
                  <Phone size={14} />
              ...
              <div className="mt-3 pt-3 border-t border-gray-100 dark:border-gray-200 dark:border-gray-700 flex justify-between items-center">
                <span className="text-gray-500 dark:text-gray-500 dark:text-gray-400 text-xs">{t('totalSpent')}</span>
      ...
      {filteredCustomers.length === 0 && (
        <div className="text-center py-12 bg-white dark:bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-200 dark:border-gray-700">
          ...
          <p className="text-gray-500 dark:text-gray-500 dark:text-gray-400">{t('noCustomersFound')}</p>
          <button
            onClick={() => setShowModal(true)}
        ...
        <div className="fixed inset-0 bg-black/50 dark:bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-white dark:bg-gray-800 rounded-2xl w-full max-w-md max-h-[90vh] overflow-y-auto border border-gray-200 dark:border-gray-200 dark:border-gray-700">
            ...
            <form onSubmit={handleSubmit} className="p-5 space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-600 dark:text-gray-300 mb-1">{t('notes')}</label>
                <textarea
                  rows="2"
        ...
        <div className="fixed inset-0 bg-black/50 dark:bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-white dark:bg-gray-800 rounded-2xl w-full max-w-md border border-gray-200 dark:border-gray-200 dark:border-gray-700">
            <div className="p-5 border-b border-gray-200 dark:border-gray-200 dark:border-gray-700 flex justify-between items-center">
              <h2 className="text-xl font-bold text-gray-900 dark:text-gray-900 dark:text-white">{t('customerDetails')}</h2>
              <button onClick={() => setShowDetailsModal(false)} className="text-gray-500 dark:text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-600 dark:text-gray-300">
                <X size={24} />
              </button>
            </div>
            ...
            <div className="p-5 space-y-4">
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center text-gray-900 dark:text-white font-bold text-2xl">
                  {selectedCustomer.name?.charAt(0)}
                </div>
                <div>
                  <h3 className="text-gray-900 dark:text-gray-900 dark:text-white font-bold text-lg">{selectedCustomer.name}</h3>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3 text-gray-700 dark:text-gray-600 dark:text-gray-300">
                  <Phone size={16} className="text-gray-500 dark:text-gray-400 dark:text-gray-500" />
                  <span>{selectedCustomer.phone || t('notProvided')}</span>
                </div>
                <div className="flex items-center gap-3 text-gray-700 dark:text-gray-600 dark:text-gray-300">
                  <Mail size={16} className="text-gray-500 dark:text-gray-400 dark:text-gray-500" />
                  <span>{selectedCustomer.email || t('notProvided')}</span>
                </div>
                <div className="flex items-center gap-3 text-gray-700 dark:text-gray-600 dark:text-gray-300">
                  <MapPin size={16} className="text-gray-500 dark:text-gray-400 dark:text-gray-500" />
                  <span>{selectedCustomer.address || t('notProvided')}</span>
                </div>
              </div>

              <div className="border-t border-gray-100 dark:border-gray-200 dark:border-gray-700 pt-4">
                <h4 className="text-gray-900 dark:text-gray-900 dark:text-white font-semibold mb-3">{t('statistics')}</h4>
                <div className="grid grid-cols-2 gap-3">
                  <div className="bg-gray-50 dark:bg-gray-100 dark:bg-gray-700 rounded-lg p-3 text-center">
                    <p className="text-gray-500 dark:text-gray-500 dark:text-gray-400 text-xs">{t('totalVisits')}</p>
                    <p className="text-gray-900 dark:text-gray-900 dark:text-white font-bold text-xl">{selectedCustomer.visit_count || 0}</p>
                  </div>
                  <div className="bg-gray-50 dark:bg-gray-100 dark:bg-gray-700 rounded-lg p-3 text-center">
                    <p className="text-gray-500 dark:text-gray-500 dark:text-gray-400 text-xs">{t('totalSpent')}</p>
              ...
              {selectedCustomer.favorite_items && selectedCustomer.favorite_items.length > 0 && (
                <div className="border-t border-gray-100 dark:border-gray-200 dark:border-gray-700 pt-4">
                  <h4 className="text-gray-900 dark:text-gray-900 dark:text-white font-semibold mb-2">{t('favoriteItems')}</h4>
              ...
              {selectedCustomer.notes && (
                <div className="border-t border-gray-100 dark:border-gray-200 dark:border-gray-700 pt-4">
                  <h4 className="text-gray-900 dark:text-gray-900 dark:text-white font-semibold mb-2">{t('notes')}</h4>
                  <p className="text-gray-600 dark:text-gray-500 dark:text-gray-400 text-sm">{selectedCustomer.notes}</p>
                </div>
              )}
            </div>
          </div>
