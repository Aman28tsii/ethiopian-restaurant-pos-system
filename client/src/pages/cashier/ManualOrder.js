...
import { 
  ...
  MapPin, CreditCard, Smartphone, DollarSign, Printer
} from 'lucide-react';
        ...
        <div className="bg-gray-800 rounded-xl p-4 border border-gray-700 mb-4">
          <div className="relative mb-4">
            ...
            <input
              ...
              className="w-full px-4 py-3 pl-10 bg-gray-700 border border-gray-600 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
            {filteredProducts.map(product => (
              <button
                ...
                className="bg-gray-800 border border-gray-700 rounded-xl p-3 text-left hover:border-blue-500 transition"
              >
            ...
            <div className="grid grid-cols-3 gap-2">
              <button
                ...
                className={`py-2 rounded-lg font-semibold flex items-center justify-center gap-2 transition ${
                  paymentMethod === 'cash' ? 'bg-green-600 text-white' : 'bg-gray-700 text-gray-300'
                }`}
              >
              ...
              <button
                ...
                className={`py-2 rounded-lg font-semibold flex items-center justify-center gap-2 transition ${
                  paymentMethod === 'card' ? 'bg-green-600 text-white' : 'bg-gray-700 text-gray-300'
                }`}
              >
              ...
              <button
                ...
                className={`py-2 rounded-lg font-semibold flex items-center justify-center gap-2 transition ${
                  paymentMethod === 'mobile' ? 'bg-green-600 text-white' : 'bg-gray-700 text-gray-300'
                }`}
              >
