  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center flex-wrap gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-900 dark:text-gray-900 dark:text-white">{t('reports')}</h1>
          <p className="text-gray-500 dark:text-gray-500 dark:text-gray-500 dark:text-gray-400 mt-1">{t('salesAndProfitAnalytics')}</p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="bg-white dark:bg-white dark:bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-200 dark:border-gray-200 dark:border-gray-700">
              <div className="flex items-center gap-3 mb-2">
                ...
                <p className="text-gray-600 dark:text-gray-500 dark:text-gray-500 dark:text-gray-400">{t('totalRevenue')}</p>
              </div>
            ...
            <div className="bg-white dark:bg-white dark:bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-200 dark:border-gray-200 dark:border-gray-700">
              <div className="flex items-center gap-3 mb-2">
                ...
                <p className="text-gray-600 dark:text-gray-500 dark:text-gray-500 dark:text-gray-400">{t('totalCost')}</p>
              </div>
            ...
            <div className="bg-white dark:bg-white dark:bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-200 dark:border-gray-200 dark:border-gray-700">
              <div className="flex items-center gap-3 mb-2">
                ...
                <p className="text-gray-600 dark:text-gray-500 dark:text-gray-500 dark:text-gray-400">{t('totalProfit')}</p>
              </div>
            ...
            <div className="bg-white dark:bg-white dark:bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-200 dark:border-gray-200 dark:border-gray-700">
              <div className="flex items-center gap-3 mb-2">
                ...
                <p className="text-gray-600 dark:text-gray-500 dark:text-gray-500 dark:text-gray-400">{t('profitMargin')}</p>
              </div>
