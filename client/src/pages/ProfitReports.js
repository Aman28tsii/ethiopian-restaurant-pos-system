  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center flex-wrap gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-900 dark:text-white">{t('profitReports')}</h1>
          <p className="text-gray-500 dark:text-gray-500 dark:text-gray-400 mt-1">{t('trackYourBusinessProfitability')}</p>
        </div>
      ...
      {todayData && (
        <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-2xl p-6 text-gray-900 dark:text-white">
      ...
      {reportData && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-white dark:bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-200 dark:border-gray-700">
            ...
            <p className="text-gray-500 dark:text-gray-500 dark:text-gray-400 text-sm">{t('totalRevenue')}</p>
          ...
          <div className="bg-white dark:bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-200 dark:border-gray-700">
            ...
            <p className="text-gray-500 dark:text-gray-500 dark:text-gray-400 text-sm">{t('totalCost')}</p>
          ...
          <div className="bg-white dark:bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-200 dark:border-gray-700">
            ...
            <p className="text-gray-500 dark:text-gray-500 dark:text-gray-400 text-sm">{t('totalProfit')}</p>
      ...
      {reportData && reportData.top_products && reportData.top_products.length > 0 && (
        <div className="bg-white dark:bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-200 dark:border-gray-700 overflow-hidden">
          <div className="p-4 border-b border-gray-200 dark:border-gray-200 dark:border-gray-700">
            <h3 className="text-gray-900 dark:text-gray-900 dark:text-white font-semibold">{t('topProducts')}</h3>
            <p className="text-gray-500 dark:text-gray-500 dark:text-gray-400 text-sm">{t('byProfitContribution')}</p>
          </div>
          <div className="overflow-x-auto">
            <table className="w-full text-left">
              <thead className="bg-gray-50 dark:bg-gray-100 dark:bg-gray-700/50">
                <tr>
                  <th className="px-6 py-3 text-gray-600 dark:text-gray-500 dark:text-gray-400 text-sm">{t('product')}</th>
                  <th className="px-6 py-3 text-gray-600 dark:text-gray-500 dark:text-gray-400 text-sm">{t('sold')}</th>
                ...
                {reportData.top_products.map((product, idx) => (
                  <tr key={idx} className="hover:bg-gray-50 dark:hover:bg-gray-100 dark:bg-gray-700/50 transition">
                    <td className="px-6 py-4">
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-500 dark:text-gray-400">{product.category}</p>
                    </td>
                    <td className="px-6 py-4 text-gray-700 dark:text-gray-600 dark:text-gray-300">{product.quantity_sold}</td>
                    <td className="px-6 py-4 text-gray-700 dark:text-gray-600 dark:text-gray-300">{formatCurrency(product.revenue)}</td>
