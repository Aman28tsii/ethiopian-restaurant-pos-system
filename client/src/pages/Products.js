...
import { Package, Plus, Edit2, Trash2, Search, X, UtensilsCrossed } from 'lucide-react';
...
const Products = () => {
    ...
    // ✅ Opens recipe manager for a PRODUCT
    ...
    return (
        <div className="space-y-6">
            ...
            {/* Products Grid - ONLY PRODUCTS */}
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {filteredProducts.map(product => (
                    <div key={product.id} className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden hover:border-blue-500/50 transition-all shadow-sm hover:shadow-md">
                        ...
                        <div className="p-4">
                            ...
                            <div className="flex gap-2 mt-4">
                                {/* ✅ Recipe button - opens RecipeManager for this PRODUCT */}
                                <button
            ...
            {filteredProducts.length === 0 && (
                <div className="text-center py-12 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
                    ...
                    <button onClick={() => setShowModal(true)} className="mt-4 text-blue-600 dark:text-blue-400">
                        {t('addYourFirstProduct')}
                    </button>
                </div>
            )}

            {/* ✅ RecipeManager - receives PRODUCT, NOT ingredient */}
