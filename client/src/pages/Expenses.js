  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center flex-wrap gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-900 dark:text-white">{t('expenseTracking')}</h1>
          <p className="text-gray-500 dark:text-gray-500 dark:text-gray-400 mt-1">{t('trackBusinessOperationalCosts')}</p>
        </div>
        <button
      ...
      <div className="bg-white dark:bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-200 dark:border-gray-200 dark:border-gray-700">
        <div className="flex flex-wrap items-center gap-4">
          <div className="flex items-center gap-2">
            <Calendar size={18} className="text-gray-500 dark:text-gray-400 dark:text-gray-500" />
            <span className="text-gray-700 dark:text-gray-600 dark:text-gray-300">{t('from')}:</span>
            <input
              type="date"
          ...
          <div className="flex items-center gap-2">
            <span className="text-gray-700 dark:text-gray-600 dark:text-gray-300">{t('to')}:</span>
            <input
              type="date"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white dark:bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-200 dark:border-gray-700">
            <div className="flex items-center gap-3 mb-2">
              ...
              <p className="text-gray-600 dark:text-gray-500 dark:text-gray-400">{t('totalExpenses')}</p>
            </div>
            <p className="text-2xl font-bold text-gray-900 dark:text-gray-900 dark:text-white">{formatCurrency(summary.summary.total_amount)}</p>
          ...
          <div className="bg-white dark:bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-200 dark:border-gray-700">
            <div className="flex items-center gap-3 mb-2">
              ...
              <p className="text-gray-600 dark:text-gray-500 dark:text-gray-400">{t('averageDaily')}</p>
            </div>
            <p className="text-2xl font-bold text-gray-900 dark:text-gray-900 dark:text-white">{formatCurrency(summary.summary.total_amount / 30)}</p>
          ...
          <div className="bg-white dark:bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-200 dark:border-gray-700">
            <div className="flex items-center gap-3 mb-2">
              ...
              <p className="text-gray-600 dark:text-gray-500 dark:text-gray-400">{t('categories')}</p>
            </div>
            <p className="text-2xl font-bold text-gray-900 dark:text-gray-900 dark:text-white">{summary.by_category.length}</p>
      ...
      {summary && summary.by_category && summary.by_category.length > 0 && (
        <div className="bg-white dark:bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-200 dark:border-gray-700 overflow-hidden">
          <div className="p-4 border-b border-gray-200 dark:border-gray-200 dark:border-gray-700">
            <h3 className="text-gray-900 dark:text-gray-900 dark:text-white font-semibold">{t('expenseByCategory')}</h3>
          </div>
          <div className="p-4">
                ...
                return (
                  <div key={idx}>
                    <div className="flex justify-between text-sm mb-1">
                      <span className="text-gray-700 dark:text-gray-600 dark:text-gray-300">{cat.category}</span>
                      <span className="text-gray-900 dark:text-gray-900 dark:text-white font-semibold">{formatCurrency(cat.total_amount)}</span>
                    </div>
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full px-4 py-3 bg-white dark:bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-300 dark:border-gray-600 rounded-xl text-gray-900 dark:text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 pl-10"
        />
        {searchTerm && (
      ...
      <div className="bg-white dark:bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-200 dark:border-gray-700 overflow-hidden">
          ...
          <table className="w-full text-left">
            <thead className="bg-gray-50 dark:bg-gray-100 dark:bg-gray-700/50">
              <tr>
                ...
                <th className="px-6 py-3 text-gray-600 dark:text-gray-500 dark:text-gray-400 text-sm">{t('category')}</th>
                <th className="px-6 py-3 text-gray-600 dark:text-gray-500 dark:text-gray-400 text-sm">{t('description')}</th>
                <th className="px-6 py-3 text-gray-600 dark:text-gray-500 dark:text-gray-400 text-sm text-right">{t('amount')}</th>
                <th className="px-6 py-3 text-gray-600 dark:text-gray-500 dark:text-gray-400 text-sm">{t('recordedBy')}</th>
                <th className="px-6 py-3 text-gray-600 dark:text-gray-500 dark:text-gray-400 text-sm">{t('actions')}</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
              {filteredExpenses.map(expense => (
                <tr key={expense.id} className="hover:bg-gray-50 dark:hover:bg-gray-100 dark:bg-gray-700/50 transition">
                  <td className="px-6 py-4 text-gray-700 dark:text-gray-600 dark:text-gray-300">
                    {new Date(expense.expense_date).toLocaleDateString()}
                  </td>
                  <td className="px-6 py-4">
                    <span className="px-2 py-1 bg-gray-100 dark:bg-gray-100 dark:bg-gray-700 rounded-lg text-sm text-gray-700 dark:text-gray-600 dark:text-gray-300">
                      {expense.category}
                    </span>
                  </td>
                  <td className="px-6 py-4 text-gray-600 dark:text-gray-500 dark:text-gray-400 max-w-xs truncate">
                    {expense.description || '-'}
                  </td>
                  <td className="px-6 py-4 text-right text-red-600 dark:text-red-400 font-semibold">
                    {formatCurrency(expense.amount)}
                  </td>
                  <td className="px-6 py-4 text-gray-500 dark:text-gray-500 dark:text-gray-400 text-sm">
        ...
        {filteredExpenses.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 dark:text-gray-500 dark:text-gray-400">{t('noExpensesFound')}</p>
          </div>
        )}
      </div>
          ...
          <div className="bg-white dark:bg-white dark:bg-gray-800 rounded-2xl w-full max-w-md border border-gray-200 dark:border-gray-200 dark:border-gray-700">
            <div className="p-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-600 dark:text-gray-300 mb-1">{t('amount')} *</label>
                  <div className="relative">
                    <DollarSign size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 dark:text-gray-400 dark:text-gray-500" />
                    <input
                      type="number"
                      step="0.01"
                      required
                      ...
                      className="w-full px-3 py-2 pl-9 bg-gray-50 dark:bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                      placeholder="0.00"
                    />
                  </div>
                </div>
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-600 dark:text-gray-300 mb-1">{t('expenseDate')} *</label>
                  <input
                    type="date"
                    required
