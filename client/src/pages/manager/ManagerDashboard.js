...
const ManagerDashboard = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-white">{t('managerDashboard')}</h1>
        <p className="text-gray-400 mt-1">{t('operationalOverview')}</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
          <div className="flex items-center gap-3 mb-2">
            ...
            <p className="text-gray-400">{t('todaySales')}</p>
          </div>
        ...
        <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
          <div className="flex items-center gap-3 mb-2">
            ...
            <p className="text-gray-400">{t('staffOnDuty')}</p>
          </div>
        ...
        <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
          <div className="flex items-center gap-3 mb-2">
            ...
            <p className="text-gray-400">{t('avgOrderValue')}</p>
          </div>
        ...
        <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-xl p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">{stats.lowStock.length} {t('ingredientsNeedReorder')}</p>
            </div>
          </div>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <button className="bg-gray-800 hover:bg-gray-700 rounded-xl p-6 text-left transition border border-gray-700">
          ...
          <h3 className="text-white font-semibold">{t('updateInventory')}</h3>
          <p className="text-gray-400 text-sm mt-1">{t('addOrEditStockLevels')}</p>
        </button>
        <button className="bg-gray-800 hover:bg-gray-700 rounded-xl p-6 text-left transition border border-gray-700">
          <TrendingUp size={24} className="text-green-400 mb-3" />
          <h3 className="text-white font-semibold">{t('viewReports')}</h3>
          <p className="text-gray-400 text-sm mt-1">{t('salesAndProfitAnalytics')}</p>
        </button>
      </div>
    </div>
  );
